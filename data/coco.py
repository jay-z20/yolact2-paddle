...
class COCODetection(Dataset):
    ...
    def __init__(self, image_path, info_file, transform=None,
        ...
        print("image_path",image_path,"info_file",info_file)
    ...
    def __getitem__(self, index):
        ...
        #print("gt",type(gt),"masks",type(masks),"num_crowds",num_crowds)
    ...
    def pull_item(self, index):
        ...
        return paddle.to_tensor(img).transpose((2, 0, 1)), target, masks, height, width, num_crowds
...
def detection_collate(batch):
    ...
    return paddle.stack(imgs, axis=0), targets, masks, num_crowds
